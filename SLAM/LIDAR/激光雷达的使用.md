...
![建模效果](LIDAR_Pic/robostudio.png)

### A1M8的夹角与距离值几何定义
![A1M8的夹角与距离值几何定义](LIDAR_Pic/A1M8.png)
...
1. 单次应答
    ...
    ![单次应答模式官方详解](LIDAR_Pic/SingleResponse.png)
2. 多次应答（最常用）
   
   ![多次应答模式官方详解](LIDAR_Pic/MutipleResponse.png)
3. 无应答
   
   ![无应答模式官方详解](LIDAR_Pic/NoResponse.png)

### 通讯数据格式
![](LIDAR_Pic/dataformat.png)
...
1. 请求报文
   ...
   ![请求命令官方详解](LIDAR_Pic/RequestOrder.png)
...
2. 起始应答报文(长度7bytes)
   ...
   ![应答模式](LIDAR_Pic/ResponseMode.png)
   ...
   ![高速采样 (EXPRESS_SCAN)的起始应答报文](LIDAR_Pic/BeginningResponse.png)

3. 数据应答报文
   1. SCAN模式的应答报文格式
    
    ![应答报文格式](LIDAR_Pic/SCANResponse.png) 
    
    ![应答报文字段解释](LIDAR_Pic/SCANResponsechar.png)
